...
void loop()
{
  ...
  //End of process return everything home & sleep
  penUp();
  //Sends X/Y-Axis back to starting position
  returnHome();
...
void moveXAxis()
{
   //move X-Axis forward 10 steps for each bit in the array
   stepperX.step(10);
   x_inc = x_inc + 10;
   delay(15);
}
